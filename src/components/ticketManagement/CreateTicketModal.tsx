        ...
        <div className="px-6 pb-6">
          ...
          <div className="mt-4">
            ...
            <select
              ...
              onChange={handleChange}
              className={`w-full px-4 py-2.5 border rounded-xl focus:outline-none dark:bg-gray-900 dark:text-white focus:ring-2 focus:ring-purple-500 ${errors.equipmentId ? 'border-red-500 dark:border-red-500' : 'border-gray-300 dark:border-gray-600'}`}
              disabled={loading}
            >
            ...
            {errors.equipmentId && (
              <p className="text-red-500 dark:text-red-400 text-xs mt-1">{errors.equipmentId}</p>
            )}
          </div>
